...
- **Blocking**: GitHub's **native issue dependencies** (the canonical, UI-visible representation). Where dependencies aren't available, fall back to a `Blocked by: #<n>` line at the top of the child body.
